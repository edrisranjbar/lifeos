...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST') {
    try {
        ...
        life_os_logout();
        $error = 'Database setup or connection is not ready. Check config.php and your MySQL access.';
    }
}
